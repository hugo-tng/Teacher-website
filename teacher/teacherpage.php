...
<body>
    <header class="row"> <?php require_once("../teacher/header.php"); ?></header>
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                <div class="text-center">
                    <img src="../img/teacher-avatar.jpg" alt="Teacher's image" class="img-fluid rounded float-end d-block">
                </div>
            </div>
            <?php
                ...
                <ul class="fs-5">
                    <?php
                        ...
                        foreach ($newsList as $item) {
                            ...
                            echo '<li><a href="research.php?id=' . $item["tuaDe"] . '">' . $item["tuaDe"] . '</a></li>';
                        }
                    ?>
                </ul>
            </div>
                ...
                <ul class="fs-5">
                    <?php
                        ...
                        foreach ($list_reverse as $item) {
                            echo '<li><a href="news.php?id=' . $item["tuaDe"] . '">[' . $item["monHocLienQuan"] . ']' . $item["tuaDe"] . '</a></li>';
                        }
                    ?>
                </ul>
            </div>
